...
execute_process(
  COMMAND "/usr/local/bin/git" --git-dir=.git show-ref "v0.0.2"
  WORKING_DIRECTORY "/Users/jackchallis/Documents/AudioCoding/Projects/DistortionVST/libs/daisysp"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/jackchallis/Documents/AudioCoding/Projects/DistortionVST/libs/daisysp'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/jackchallis/Documents/AudioCoding/Projects/DistortionVST/libs/daisysp'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
